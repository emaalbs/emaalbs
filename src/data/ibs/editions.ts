...
export const editions: IbsEdition[] = [
	{
		...
		heroImage: "/images/hero-summit.webp",
		recapVideo: "/videos/ibs-2025-recap-en.mp4",
		stats: [
		...
		sponsors: [
			{ id: "idb", name: "International Development Bank", tier: "strategic", logo: "/logos/international-development-bank.webp" },
			{ id: "tbi", name: "Trade Bank of Iraq", tier: "strategic", logo: "/logos/basra-gate-terminal.webp" },
			{ id: "ahli", name: "Al Ahli Iraqi Bank", tier: "platinum", logo: "/logos/industrial-cities-corporation.webp" },
			{ id: "asiacell", name: "Asiacell", tier: "platinum", logo: "/logos/nokia.webp" },
			{ id: "ports", name: "General Company for Iraqi Ports", tier: "gold", logo: "/logos/visa.webp" },
		],
		gallery: [
			{
				id: "g1",
			...
			{
				id: "g2",
				src: "/images/panel-discussion.webp",
				alt: { en: "Panel discussion", ar: "جلسة نقاش" },
			},
			{
				id: "g3",
				src: "/images/networking-session.webp",
				alt: { en: "Networking session", ar: "جلسة تواصل" },
			},
			{
				id: "g4",
				src: "/images/keynote-speech.webp",
	...
	},
	{
		...
		heroImage: "/images/venture-tech.webp",
		stats: [
