export const en = {
  ...
  footer: {
    ...
    social: [
      { label: "LinkedIn", href: "https://www.linkedin.com/company/emaal/" },
      { label: "X / Twitter", href: "https://x.com/emaal_bs" },
      { label: "Instagram", href: "https://www.instagram.com/emaal_business_space/" },
      { label: "YouTube", href: "https://www.youtube.com/@IraqBusinessSummit" },
      { label: "Facebook", href: "https://www.facebook.com/EMAAL.Business.Space/" },
    ],
  ...
  about: {
    ...
    steps: [
      { n: "01", t: "Touch Base", d: "Kick off meeting to align on goals." },
      {
        n: "02",
        t: "Evaluation",
        d: "Deep analysis with a clear action plan.",
      },
  ...
  services: {
    ...
    list: [
      ...
      },
      {
        ...
        img: "/images/keynote-speech.webp",
      },
      {
        tag: "Convene",
      ...
      //   img: "/images/panel-discussion.webp",
      // },
    ],
  },
  group: {
    ...
    brands: [
      ...
      },
      {
        ...
        img: "/images/venture-gaming.webp",
      },
    ],
    visit: "Visit",
  },
    ...
    posts: [
      {
        ...
        date: "April 2025",
        title:
          "How IBS 2025 reshaped Iraq's investment conversation in three days",
        img: "/images/summit-stage.webp",
        readTime: "6 min read",
      },
      {
        ...
        date: "March 2025",
        title:
          "Six sectors, one platform: why Iraq's growth story needs coordination",
        img: "/images/panel-discussion.webp",
        readTime: "4 min read",
      },
      {
        ...
        img: "/images/networking-session.webp",
        readTime: "3 min read",
      },
    ],
  ...
  statsBar: {
    ...
    stats: [
      ...
      },
      {
        value: 200,
        suffix: "+",
        label: "Market Engagements",
        note: "Media + B2B reach",
      },
      {
        value: 6,
        suffix: "",
        label: "Economic Sectors",
        note: "Vital industries covered",
      },
    ],
  },
  ctaBand: {
  ...
  ibsPage: {
    ...
    hero: {
      ...
      ctaSecondary: "Request Participation",

      videoButtonPlay: "Play Sound",

      videoButtonMute: "Mute Sound",
    },
      ...
      groups: [
        {
          ...
          items: [
            ...
            "Heads of regulatory authorities and public institutions",
            "Directors General and senior policymakers",
          ],
        },

        {
          ...
          items: [
            "CEOs and Managing Directors of leading companies",
            "Chairmen and executives from major Iraqi and regional groups",
          ],
        },

        {
          title: "International & Regional Stakeholders",

          items: [
            "Representatives from international organizations and financial institutions",
            "Embassy and trade representatives",
            "Regional business leaders and investors",
          ],
        },
      ],
    },
    ...
    leaders: {
      ...
      items: [
        "The Minister of Communication, Hayam Al-Yasri",

        "The Minister of Industry, Khalid Batal",

        "Director General of the General Company for Iraqi Ports Dr. Farhan Al-Fartusi",

        "CEO of Bank of International Development Fadi Al-Faqiyah",

        "Central Region General Manager Asiacell Company Saman Bojan",
      ],
    },
    ...
    sponsorship: {
      ...
      description:
        "IBS offers different levels of participation, allowing companies to engage based on their strategic objectives and level of involvement.",
      ...
      packages: [
        {
          ...
          features: [
            ...
            "Dedicated branded platform (HOUSE) to host discussions, launch projects, and sign agreements",
          ],
        },

        {
          ...
          features: [
            ...
            "Direct engagement with government entities",
            "Invitation to targeted stakeholders",
            "Business Club membership (network access)",
            "Coordinated B2B meetings",
            "Strong brand visibility across summit platforms",
            "Media exposure and interview opportunities",
          ],
        },

        {
          ...
          description:
            "Focused engagement and sector presence.",

          features: [
            "Speaker participation in selected sessions",
            "Access to executive roundtables",
            "Direct engagement with stakeholders",
            "Exhibition presence and branding",
            "Visibility across summit materials",
            "Media coverage through official partners",
          ],
        },

        {
          ...
          features: [
            "Attendance at sessions and discussions",
            "Access to networking spaces",
            "Participation in selected roundtables",
            "Visibility across summit channels",
          ],
        },
      ],
    },
    ...
    participation: {
      title: "What Participation Enables",
    ...
    house: {
      ...
      footer:
        "A platform for leadership, visibility, and real execution.",
    },

    beyond: {
      title: "Beyond a Summit",

      description:
        "IBS is not just about attendance it is about outcomes.",
