...
export function GalleryAlbumView({ album, locale, initialImageId }: Props) {
	...
	const labels = isAr ? { back: "كل المعرض", photos: "صور", shareAlbum: "مشاركة الألبوم", shareImage: "مشاركة الصورة", copied: "تم نسخ الرابط", close: "إغلاق", next: "الصورة التالية", previous: "الصورة السابقة" } : { back: "All gallery", photos: "Photos", shareAlbum: "Share album", shareImage: "Share image", copied: "Link copied", close: "Close", next: "Next image", previous: "Previous image" };
