...
export async function middleware(request: NextRequest) {
	...
	if (pathname.startsWith("/api/blogs") || pathname.startsWith("/api/ibs") || pathname.startsWith("/api/media") || pathname.startsWith("/api/magazines") || pathname.startsWith("/api/social-posts")) {
		if (method === "GET") {
